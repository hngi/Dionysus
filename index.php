...
<body>
	...
	<div class="row">
			<div class="col-sm-5 mb-4">
				<h1>Get your expenses done Together</h1>
				<h5>Financial Management made easy</h5>
				<div class="col text-center">
					<a href="signup.php">
					<button type="submit" class="btn  btn-outline-primary col-md-4 mb-4 btn-lg" id="signup" value="SignUp">Start here</button>
				    </a>
				</div>
			</div>
